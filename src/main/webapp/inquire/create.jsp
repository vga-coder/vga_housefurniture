...
<FORM name='frm' method='POST' action='./create.do' class="form-horizontal">
 <input type='hidden' name='inquirecateno' value='1'>
 <input type='hidden' name='memno' value='2'>
  <div class="form-group">
     <label class="control-label col-md-3">문의 제목</label>
     <div class="col-md-9">
       <input type='text' name='inquire_title' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>
  <div class="form-group">
     <label class="control-label col-md-3">문의 내용</label>
     <div class="col-md-9">
       <input type='text' name='inquire_content' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>  
